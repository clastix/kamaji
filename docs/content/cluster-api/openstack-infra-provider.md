...
!!! warning "Development-Oriented Management Cluster"
    A local `kind` cluster serves as the management cluster. Production environments typically use a highly available, persistent management cluster.
