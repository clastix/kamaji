...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreGeneratedCertificatesSpec) DeepCopyInto(out *PreGeneratedCertificatesSpec) {
	*out = *in
	if in.CA != nil {
		in, out := &in.CA, &out.CA
		*out = new(CertificateReference)
	...
	if in.FrontProxyClient != nil {
		in, out := &in.FrontProxyClient, &out.FrontProxyClient
		*out = new(CertificateReference)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreGeneratedCertificatesSpec.
func (in *PreGeneratedCertificatesSpec) DeepCopy() *PreGeneratedCertificatesSpec {
	if in == nil {
		return nil
	}
	out := new(PreGeneratedCertificatesSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RBACBootstrapStatus) DeepCopyInto(out *RBACBootstrapStatus) {
	*out = *in
	in.ClusterRoleBinding.DeepCopyInto(&out.ClusterRoleBinding)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RBACBootstrapStatus.
func (in *RBACBootstrapStatus) DeepCopy() *RBACBootstrapStatus {
	if in == nil {
		return nil
	}
	out := new(RBACBootstrapStatus)
...
func (in *TenantControlPlaneSpec) DeepCopyInto(out *TenantControlPlaneSpec) {
	*out = *in
	...
	if in.PreGeneratedCertificates != nil {
		in, out := &in.PreGeneratedCertificates, &out.PreGeneratedCertificates
		*out = new(PreGeneratedCertificatesSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Bootstrap != nil {
