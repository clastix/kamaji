...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesGatewayRoutesStatus) DeepCopyInto(out *KubernetesGatewayRoutesStatus) {
	*out = *in
	if in.HTTPRouteStatus != nil {
		in, out := &in.HTTPRouteStatus, &out.HTTPRouteStatus
		*out = new(v1.HTTPRouteStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.GRPCRouteStatus != nil {
		in, out := &in.GRPCRouteStatus, &out.GRPCRouteStatus
		*out = new(v1.GRPCRouteStatus)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesGatewayRoutesStatus.
func (in *KubernetesGatewayRoutesStatus) DeepCopy() *KubernetesGatewayRoutesStatus {
	if in == nil {
		return nil
	}
	out := new(KubernetesGatewayRoutesStatus)
	in.DeepCopyInto(out)
	return out
}
