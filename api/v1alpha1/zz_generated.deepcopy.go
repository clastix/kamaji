...
func (in *BootstrapSpec) DeepCopyInto(out *BootstrapSpec) {
	*out = *in
	...
	if in.InitManifests != nil {
		in, out := &in.InitManifests, &out.InitManifests
...
func (in *TenantControlPlaneSpec) DeepCopyInto(out *TenantControlPlaneSpec) {
	*out = *in
	...
	if in.InternalCACertificatesConfigMap != nil {
		in, out := &in.InternalCACertificatesConfigMap, &out.InternalCACertificatesConfigMap
		*out = new(string)
		**out = **in
	}
}
