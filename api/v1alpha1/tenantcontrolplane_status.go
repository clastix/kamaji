...
// +kubebuilder:validation:Enum=Provisioning;CertificateAuthorityRotating;Upgrading;Migrating;Ready;NotReady;Sleeping;ReadOnly
...
var (
	...
	VersionReadOnly     KubernetesVersionStatus = "ReadOnly"
