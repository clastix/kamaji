...
|------------|------|---------|
| https://clastix.github.io/charts | kamaji-etcd | 0.6.0 |
...
| etcd.overrideName | string | `"kamaji-etcd"` | (string) If the creation of an etcd instance is disabled, specify the default DataStore name for the Kamaji instance. |
...
| kamaji-etcd.datastore.enabled | bool | `true` | Create a DataStore custom resource for Kamaji. |
